                            ...
                            AudioBufferList *ioData)
{
	...
	// In this case, the VWW_ThereminSynthesizer passed itself so
	// that you can access its data.
	VWW_ThereminSynthesizer* THIS = (VWW_ThereminSynthesizer*)inRefCon;
...
@interface VWW_ThereminSynthesizer ()
...
@implementation VWW_ThereminSynthesizer
